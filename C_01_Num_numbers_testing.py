...
# Start the main code
# Start Rounds
num_questions = int_check("How many rounds would you like to play? Press <enter> for infinite mode: ",
                          low=1)
...
while questions_answered < num_questions:
    ...
    # num_numbers = random.choice(num_numbers_list)

    # print(num_numbers_list)
